...
describe('JsonVariableResolver', () => {
    ...
    test('should throw an error for circular references', () => {
        ...
        expect(() => resolver.resolve(json)).toThrow('Circular reference detected at path: b');
    });
    ...
    test('should handle self-referencing variables', () => {
        ...
        expect(() => resolver.resolve(json)).toThrow('Circular reference detected at path: a');
    });
    ...
    test('should handle multiple nested variables with circular reference', () => {
        ...
        expect(() => resolver.resolve(json)).toThrow('Circular reference detected at path: c.d');
    });
    ...
    test('should throw an error for array index out of bounds', () => {
        const json = {
            arr: [1, 2, 3],
            value: "${arr[3]}"
        };

        expect(() => resolver.resolve(json)).toThrow('Array index out of bounds: arr[3]');
    });
